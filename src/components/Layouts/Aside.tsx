...
import { MdOutlineDashboard, MdLogout, MdListAlt } from "react-icons/md";
					...
					<ul className="space-y-2 font-medium mt-8">
						<li>
							<a href="/dashboard" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
								...
								<span className="ms-3 group-hover:text-blue-500">Dashboard</span>
							</a>
						</li>
						<li>
							<button type="button" onClick={showMenu} className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
								...
								<span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap group-hover:text-blue-500">Data</span>
							...
							<div className={(isShow === false ? "hidden" : "block")}>
								<ul id="dropdown-example" className="py-2 space-y-2">
									<li>
										<a href="/dashboard" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Santri</a>
									</li>
									<li>
										<a href="/dashboard/kelas" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Kelas</a>
									</li>
									<li>
									<a href="/dashboard/tabungan" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Tabungan</a>
									</li>
								</ul>
							</div>
						</li>
						<li>
							<a href="/auth" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
								...
								<span className="flex-1 ms-3 whitespace-nowrap group-hover:text-blue-500">Sign Out</span>
							</a>
						</li>
						<li>
							<a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
				...
				<footer className="bg-white dark:bg-gray-900">
					<div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
						<div className="md:flex md:justify-between">
							<div className="mb-6 md:mb-0">
								<a href="https://flowbite.com/" className="flex items-center">
									<Image src={'./../../public/flowbite-logo.svg'} width={40} height={40} className="w-8 h-8 me-3" alt="FlowBite Logo" />
									<span className="self-center text-2xl font-semibold whitespace-nowrap text-blue-500">Karamel.id</span>
								</a>
							</div>
						...
						<div className="sm:flex sm:items-center sm:justify-between">
							<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Karamel™</a>. All Rights Reserved.
							</span>
